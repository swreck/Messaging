...
CRITICAL: research_website, research_audience, and test_differentiation are ACTIONS, not markers. Use the standard actions field of your response, like create_offering or add_priorities. Findings that resolve a Round D claim populate origin = RESEARCH and sourceRef = the URL.
